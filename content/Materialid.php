...
global $yhendus;
//lisamine ISERT INTO
if(isset($_REQUEST['matvorm'])){
    $kask=$yhendus->prepare('INSERT INTO meterialid(materialid) VALUES(?, ?)');
    $kask->bind_param('ss', $_REQUEST['matnimi'],$_REQUEST['pilt']);
    $kask->execute();
    //"s"-string
...
<div class="leftcolumn">
    ...
    //näitame puunimed
    global $yhendus;
    $kask=$yhendus->prepare("SELECT id, materialid FROM meterialid");
    ...
    if(isSet($_REQUEST['lisa'])){
        ...
        <form action="" method="post">
            <input type="hidden" name="matvorm" value="jah">
...
<div class="rightcolumn">
    ...
    if(isset($_REQUEST['id'])){
        $kask=$yhendus->prepare("SELECT id, materialid FROM meterialid where id=?");
